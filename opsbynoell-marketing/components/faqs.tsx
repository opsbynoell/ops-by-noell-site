  ...
  const questions = [
    {
      ...
      answer:
        "Most clients are fully live within 5-7 business days.",
    },
    {
      question: "Do I need to change my booking software?",
      answer:
        "No. We integrate with whatever you already use — Square, Jane, Vagaro, Mindbody, you name it.",
    },
    {
      question: "What if I already have a receptionist?",
      answer:
        "Great — we handle the overflow. Missed calls after hours, lunch breaks, busy periods. Your receptionist stays, your coverage doubles.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Appointment-based service businesses: massage therapists, med spas, salons, dental offices, estheticians, and home service providers in Orange County.",
    },
  ];
  return (
    <section
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <h3 className="text-lg md:text-2xl font-bold font-display text-left">
          {question}
        </h3>
