        ...
        <div className="container">
          ...
          >
            ...
            <div style={{
              ...
              {[
                { emoji: '💬', text: 'Answers inquiries instantly — even at 11 PM' },
                { emoji: '📅', text: 'Books appointments directly into your calendar' },
                { emoji: '🔍', text: 'Qualifies leads before they reach you' },
                { emoji: '🗣️', text: 'Handles objections like a real front desk' },
                { emoji: '📲', text: 'Works across web chat, SMS, Instagram DMs, and Google' },
              ].map((item) => (
