        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, paddingTop: 'clamp(2rem, 4vw, 2.5rem)', textAlign: 'center', paddingBottom: '5.5rem' }}>
          <div style={{ marginBottom: '1.5rem' }}><SectionBadge>Home Services Automation</SectionBadge></div>
            ...
            <h1 style={{ fontFamily: "'Nicholas', serif", fontSize: 'clamp(1.75rem, 5vw, 3.5rem)', fontWeight: 800, lineHeight: 1.7, letterSpacing: '-0.03em', maxWidth: '820px', marginBottom: '1.75rem' }}>
              <span style={{ color: '#1A1A1A' }}>Most home service jobs are won or lost after 5pm.</span>{' '}<GradientText>We make sure you win them.</GradientText>
            </h1>
            ...
            {serviceDetails.map((svc, i) => (
              <div className="reveal">
                <div style={{ padding: '2.25rem', background: 'rgba(167,139,250,0.03)', border: '1px solid #E8E8E8', borderRadius: '12px', height: '100%' }}>
                  ...
                  <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.9375rem', color: '#555555', lineHeight: 1.75 }}>{svc.body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ padding: 'clamp(2rem, 5vw, 5rem) 0', background: 'rgba(167,139,250,0.03)', borderTop: '1px solid #E5E5E5', borderBottom: '1px solid #E5E5E5' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.25rem' }}>
            {stats.map((s, i) => (
              <div className="reveal">
                <div style={{ padding: '2rem', background: '#FFFFFF', border: '1px solid #E8E8E8', borderRadius: '12px', textAlign: 'center' }}>
                  <div style={{ fontFamily: "'Nicholas', serif", fontSize: 'clamp(1.375rem, 4vw, 2.5rem)', fontWeight: 800, color: '#0CA2A2', lineHeight: 1, marginBottom: '0.75rem', letterSpacing: '-0.03em' }}>{s.num}</div>
                  <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.875rem', color: '#555555', lineHeight: 1.6 }}>{s.label}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container">
          <div className="reveal">
            <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
              ...
              <p style={{ fontFamily: "'Nicholas', serif", fontSize: '1rem', color: '#555555', lineHeight: 1.75, maxWidth: '500px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', maxWidth: '960px', margin: '0 auto 4rem' }}>
            ...
            <div className="reveal">
              <div style={{ padding: '2rem', background: 'rgba(167,139,250,0.02)', border: '1px solid #E8E8E8', borderRadius: '12px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ marginBottom: '0.5rem' }}>
                  ...
                  <span style={{ fontFamily: "'Nicholas', serif", fontSize: '0.875rem', color: '#555555' }}>/mo</span>
                </div>
                <div style={{ fontFamily: "'Nicholas', serif", fontSize: '0.875rem', color: '#555555', marginBottom: '1.5rem' }}>+ $497 setup fee</div>
                <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.9375rem', color: '#555555', lineHeight: 1.65, marginBottom: '1.5rem' }}>Missed call text-back only. The single highest-ROI automation for home service businesses — deploy it in days.</p>
            ...
            <div className="reveal">
              <div style={{ padding: '2rem', background: 'rgba(167,139,250,0.05)', border: '1px solid rgba(167,139,250,0.3)', borderRadius: '12px', height: '100%', display: 'flex', flexDirection: 'column', position: 'relative' }}>
                ...
                <div style={{ fontFamily: "'Nicholas', serif", fontSize: '0.875rem', color: '#555555', marginBottom: '1.5rem' }}>+ $997 setup fee</div>
                <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.9375rem', color: '#555555', lineHeight: 1.65, marginBottom: '1.5rem' }}>Full lead capture, follow-up, booking, and review generation. The complete stack for a busy home service operation.</p>
                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem', display: 'flex', flexDirection: 'column', gap: '0.625rem', flex: 1 }}>
            ...
            <div className="reveal">
              <div style={{ padding: '2rem', background: 'rgba(167,139,250,0.02)', border: '1px solid #E8E8E8', borderRadius: '12px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ fontFamily: "'Nicholas', serif", fontSize: '0.875rem', color: '#555555', marginBottom: '1.5rem' }}>+ $1,497 setup fee</div>
                <p style={{ fontFamily: "'Nicholas', serif", fontSize: '0.9375rem', color: '#555555', lineHeight: 1.65, marginBottom: '1.5rem' }}>Everything in Starter plus AI voice agent, seasonal maintenance campaigns, and advanced pipeline management.</p>
                <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 2rem', display: 'flex', flexDirection: 'column', gap: '0.625rem', flex: 1 }}>
