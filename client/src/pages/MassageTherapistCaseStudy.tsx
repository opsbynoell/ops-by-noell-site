  ...
  return (
    <div style={{ backgroundColor: '#010509', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', paddingTop: '80px', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, zIndex: 0, pointerEvents: 'none', background: 'linear-gradient(180deg, rgba(120,58,237,0.18) 0%, rgba(139,92,246,0.12) 35%, #010509 72%)' }} />
        <div className="container" style={{ position: 'relative', zIndex: 1, paddingTop: '5rem', paddingBottom: '5.5rem' }}>
          <FadeItem delay={0}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
              ...
              <span style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.625rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#010509', background: 'linear-gradient(135deg, #A78BFA, #C4B5FD)', padding: '0.3rem 0.875rem', borderRadius: '99px' }}>
          ...
          <FadeItem delay={0.2}>
            <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '1.0625rem', color: '#868583', lineHeight: 1.75, maxWidth: '560px', marginBottom: '2rem' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', marginBottom: '2rem' }}>
              {[
                ...
                <div key={i} className="feature-card" style={{ padding: '1rem 1.5rem' }}>
                  <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.625rem', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#A78BFA', marginBottom: '0.25rem' }}>{item.label}</p>
        ...
        <div className="container">
          <FadeItem delay={0}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '4rem', alignItems: 'start' }} className="lg:grid-cols-2">
              ...
              <div style={{ background: 'rgba(167,139,250,0.04)', border: '1px solid rgba(167,139,250,0.15)', borderLeft: '3px solid #A78BFA', borderRadius: '8px', padding: '3rem' }}>
            ...
            {gaps.map((gap, i) => (
              <FadeItem key={i} delay={i * 0.08}>
                <div className="feature-card" style={{ padding: '2rem', height: '100%' }}>
                  ...
                  <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.875rem', color: '#868583', lineHeight: 1.7 }}>{gap.detail}</p>
                </div>
              </FadeItem>
            ))}
          </div>
            ...
            {built.map((item, i) => (
              <FadeItem key={i} delay={i * 0.1}>
                <div style={{ background: i % 2 === 0 ? 'rgba(167,139,250,0.02)' : 'rgba(167,139,250,0.04)', padding: '1.75rem 2rem', display: 'flex', alignItems: 'flex-start', gap: '1.5rem' }}>
                  <div style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'rgba(167,139,250,0.15)', border: '1px solid rgba(167,139,250,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: '2px' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.9375rem', color: '#868583', lineHeight: 1.7 }}>{item.detail}</p>
                  </div>
                </div>
              </FadeItem>
            ))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1px', background: 'rgba(167,139,250,0.12)', borderRadius: '12px', overflow: 'hidden' }} className="md:grid-cols-2">
            <FadeItem delay={0}>
              <div style={{ background: 'rgba(255,255,255,0.01)', padding: '2.5rem', height: '100%' }}>
                <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.625rem', fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                  Before Ops by Noell
                </p>
            ...
            <FadeItem delay={0.12}>
              <div style={{ background: 'rgba(167,139,250,0.04)', borderLeft: '2px solid rgba(167,139,250,0.4)', padding: '2.5rem', height: '100%' }}>
                <p style={{ fontFamily: "'Sora', sans-serif", fontSize: '0.625rem', fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#A78BFA', marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid rgba(167,139,250,0.2)' }}>
                  After Ops by Noell
                </p>
                {afterItems.map((item, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.875rem' }}>
                    <div style={{ width: '20px', height: '20px', borderRadius: '4px', flexShrink: 0, background: 'rgba(167,139,250,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <section style={{ position: 'relative', padding: '7rem 0', borderTop: '1px solid rgba(167,139,250,0.08)', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '680px', margin: '0 auto' }}>
          <FadeItem delay={0}>
            ...
            <h2 style={{ fontFamily: "'Nicholas', serif", fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.03em', marginTop: '1.25rem', marginBottom: '1.25rem', background: 'linear-gradient(90deg, #A78BFA 0%, #C4B5FD 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'block' }}>
