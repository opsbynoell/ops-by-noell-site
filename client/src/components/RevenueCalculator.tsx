 ...
 * Design: Light theme — #FFFFFF bg, #0CA2A2 accent, Nicholas serif
 */
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontSize: '0.5em', color: 'rgba(12,162,162,0.3)', letterSpacing: '0.05em', fontFamily: "'Nicholas', serif", fontWeight: 400 }}>
                  / year
                </span>
              </div>
            </div>
